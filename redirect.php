  ...
  <body>
    <div class="container">
      ...
      <div class="page-header">
        ...
        <p class="lead" style=color:blue>Thank you for your donation for Suicide Prevention.</p>
      </div>

      <strong><h3 style="color:#6da552">Thank You..!! Payment Done Sucessfully!!</h3> </strong>
   
    <p> Thank you for supporting for a cause to prevent Suicide. Your donation can save a life and help them with new beginings.
</p>
